...
def get_cluster(index,action_dir,nn_path,cls_path,out_path):
    actions=get_actions(action_dir,nn_path,cls_path)
...
if __name__ == "__main__":
   ...
   nn_path=exp_path+"nn"
   cls_path=exp_path+"clust.obj"
   out_path=exp_path+"dataset.seq"
   #create_seq_dataset(action_path,nn_path,cls_path,out_path)
   show_path="/home/user/df/cls/A/"
   get_cluster(1,action_path,nn_path,cls_path,show_path)
